...
class TestContainerProtocol(unittest.TestCase):
    ...
    def test_nagative_contained(self):
    ...
    def test_nagative_not_contained(self):
...
class TestInqualityProtocol(unittest.TestCase):

    def test_positive_unequal(self):
        self.assertTrue(
            SortedFrozenSet([4, 5, 6]) != SortedFrozenSet([4, 5, 9])
        )
...
class TestRelationalProtocol(unittest.TestCase):
